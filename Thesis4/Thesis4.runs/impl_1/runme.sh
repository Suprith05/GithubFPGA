...
HD_PWD='C:/Users/SUPRITH/Thesis4/Thesis4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_gpio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_gpio.tcl -notrace
