...
HD_PWD='C:/Users/SUPRITH/Thesis4/Thesis4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_gpio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_gpio.tcl
