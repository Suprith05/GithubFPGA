...
begin
  hpin(19 downto 17) <= \^hpin\(19 downto 17);
  hpin(16 downto 15) <= \^hpin\(18 downto 17);
  hpin(14) <= \^hpin\(18);
  hpin(13 downto 11) <= \^hpin\(19 downto 17);
  hpin(10 downto 9) <= \^hpin\(18 downto 17);
  hpin(8) <= \^hpin\(8);
  hpin(7) <= \^hpin\(8);
  hpin(6 downto 5) <= \^hpin\(18 downto 17);
  hpin(4 downto 3) <= \^hpin\(18 downto 17);
  hpin(2 downto 1) <= \^hpin\(18 downto 17);
  hpin(0) <= \^hpin\(18);
...
\hpin[13]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"C8F0"
    )
        port map (
