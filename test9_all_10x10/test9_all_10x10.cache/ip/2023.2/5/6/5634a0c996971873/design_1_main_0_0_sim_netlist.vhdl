...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main is
  ...
  attribute SOFT_HLUTNM of \vpin[0]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \vpin[1]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \vpin[2]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \vpin[3]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \vpin[4]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \vpin[5]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \vpin[6]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \vpin[7]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \vpin[8]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \vpin[9]_INST_0\ : label is "soft_lutpair14";
begin
...
\vpin[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[1]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[2]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[3]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[4]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[5]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[6]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[7]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[8]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\vpin[9]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main
     port map (
      ...
      set => set,
      vpin(9 downto 0) => vpin(9 downto 0),
      vpin_in(9 downto 0) => vpin_in(9 downto 0)
    );
end STRUCTURE;
